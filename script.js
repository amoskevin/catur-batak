...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelector('.ulang-dulu').addEventListener('click', () => {
        game.reset();
        board.start();
    ...
    document.querySelector('.atur-dulu').addEventListener('click', () => {
    ...
    document.querySelector('.tukar-dulu').addEventListener('click', () => {
        board.flip();
        makeRandomMove();
